...
class WorkoutSupplements @Inject constructor() : ContractWorkoutSupplements {

    override fun contractWorkoutSupplements(mapWorkout: MutableMap<String, String>): MutableMap<String, String> {
