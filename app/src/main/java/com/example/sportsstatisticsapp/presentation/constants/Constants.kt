package com.example.sportsstatisticsapp.presentation.constants

object Constants {

    // MainNavHost
    const val ROUT_SETTING = "settings"
    const val ROUT_STATISTIC = "statistic"
    const val ROUT_MAIN_SCREEN = "main_screen"
    ...
    const val ROUT_ADD_NEW_WORKOUT = "add_new_workout"

    const val TITLE_SETTING = "Settings"
    const val TITLE_STATISTIC = "Statistic"
    const val TITLE_MAIN_SCREEN = "MainScreen"
    ...
    const val TITLE_ADD_NEW_WORKOUT = "  Add  "
